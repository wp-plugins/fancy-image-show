...
<div class="wrap">
  ...
  <div class="tool-box">
    ...
    <form name="frm_FancyImg_display" method="post">
      ...
      <br />
      Note: Check official website gopiplus.com for live demo and more help. Don't upload your original images into plugin folder. if you upload the images into plugin folder, you may loose the images when you upate the plugin to next version.
    </form>
  </div>
</div>

    ...
    <table width="100%">
      ...
      <tr>
        <td align="left" valign="middle"><select name="FancyImg_Gallery" id="FancyImg_Gallery">
			...
			<option value='GALLERY10' <?php if(@$FancyImg_Gallery_x=='GALLERY10') { echo 'selected' ; } ?>>GALLERY10</option>
			<option value='GALLERY11' <?php if(@$FancyImg_Gallery_x=='GALLERY11') { echo 'selected' ; } ?>>GALLERY11</option>
			<option value='GALLERY12' <?php if(@$FancyImg_Gallery_x=='GALLERY12') { echo 'selected' ; } ?>>GALLERY12</option>
			<option value='GALLERY13' <?php if(@$FancyImg_Gallery_x=='GALLERY13') { echo 'selected' ; } ?>>GALLERY13</option>
			<option value='GALLERY14' <?php if(@$FancyImg_Gallery_x=='GALLERY14') { echo 'selected' ; } ?>>GALLERY14</option>
			<option value='GALLERY15' <?php if(@$FancyImg_Gallery_x=='GALLERY15') { echo 'selected' ; } ?>>GALLERY15</option>
			<option value='GALLERY16' <?php if(@$FancyImg_Gallery_x=='GALLERY16') { echo 'selected' ; } ?>>GALLERY16</option>
			<option value='GALLERY17' <?php if(@$FancyImg_Gallery_x=='GALLERY17') { echo 'selected' ; } ?>>GALLERY17</option>
			<option value='GALLERY18' <?php if(@$FancyImg_Gallery_x=='GALLERY18') { echo 'selected' ; } ?>>GALLERY18</option>
			<option value='GALLERY19' <?php if(@$FancyImg_Gallery_x=='GALLERY19') { echo 'selected' ; } ?>>GALLERY19</option>
			<option value='GALLERY20' <?php if(@$FancyImg_Gallery_x=='GALLERY20') { echo 'selected' ; } ?>>GALLERY20</option>
          </select>
  ...
  <div class="tool-box">
    ...
    <form name="frm_FancyImg_display" method="post">
      <table width="100%" class="widefat" id="straymanage">
        ...
        <tbody>
          <tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
            <td align="left" valign="middle">[fancy-img-show gallery="<?php echo(stripslashes($data->FancyImg_Gallery)); ?>"]</td>
	  ...
	  <ol>
		...
		<li>Add the gallery in the posts or pages</li>
		<li>Add directly in the theme</li>
	  </ol>
      Check official website <a href="http://www.gopiplus.com/work/2011/11/06/fancy-image-show-wordpress-plugin/">www.gopiplus.com</a> for live demo and more help. <br /><br />
